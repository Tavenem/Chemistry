...
namespace Tavenem.Chemistry.Test
{
    ...
    public class SubstanceTests
    {
        ...
        public void FormulaTest()
        {
            ...
            Assert.AreEqual(Chemistry.Elements.PeriodicTable.Instance[1].GetCommonIsotope(), nuclides[0].nuclide);
            Assert.AreEqual(2, nuclides[0].amount);
            Assert.AreEqual(Chemistry.Elements.PeriodicTable.Instance[8].GetCommonIsotope(), nuclides[1].nuclide);
            ...
            Assert.AreEqual(2, nuclides.Count);
            Assert.AreEqual(Chemistry.Elements.PeriodicTable.Instance[16].GetCommonIsotope(), nuclides[0].nuclide);
