...
namespace Tavenem.Chemistry.Doubles
{
    ...
    public static class Materials
    {
        ...
        /// zero <see cref="IMaterial.Mass"/>; or <see cref="double.PositiveInfinity"/> if it has a
        /// radius of zero.
        /// </returns>
        public static double GetSurfaceGravity(this IMaterial material)
        {
            ...
            return Mathematics.DoubleConstants.G * material.Mass / material.Shape.ContainingRadius.Square();
        }
