...
namespace Tavenem.Chemistry.Doubles
{
    ...
    public class Material : IMaterial, ISerializable, IEquatable<Material>
    {
        ...
        /// constituents.
        /// </remarks>
        public Material(ISubstanceReference substance, IShape shape, double? mass = null, double? density = null, double? temperature = null)
        {
        ...
        /// constituents.
        /// </remarks>
        public Material(ISubstance substance, IShape shape, double? mass = null, double? density = null, double? temperature = null)
        ...
        /// </para>
        /// </remarks>
        public Material(IShape shape, double? mass = null, double? density = null, double? temperature = null)
        {
            Shape = shape;
            if (!density.HasValue)
            {
        ...
        /// constituents.
        /// </remarks>
        public Material(IEnumerable<(ISubstanceReference substance, decimal proportion)>? substances, IShape shape, double? mass = null, double? density = null, double? temperature = null)
        {
            Shape = shape;
        ...
        /// constituents.
        /// </remarks>
        public Material(IEnumerable<(ISubstance substance, decimal proportion)>? substances, IShape shape, double? mass = null, double? density = null, double? temperature = null)
        ...
        /// constituents.
        /// </remarks>
        public Material(IShape shape, double? mass = null, double? density = null, double? temperature = null, params (ISubstanceReference substance, decimal proportion)[] substances)
        {
            Shape = shape;
        ...
        /// constituents.
        /// </remarks>
        public Material(IShape shape, double? mass = null, double? density = null, double? temperature = null, params (ISubstance substance, decimal proportion)[] substances)
        ...
        /// constituents.
        /// </remarks>
        public Material(IDictionary<ISubstanceReference, decimal>? substances, IShape shape, double? mass = null, double? density = null, double? temperature = null)
        {
        ...
        public Material(IReadOnlyDictionary<ISubstanceReference, decimal> constituents, double density, double mass, IShape shape, double? temperature)
        {
        ...
        private Material(SerializationInfo info, StreamingContext context) : this(
            ...
            (double?)info.GetValue(nameof(Mass), typeof(double)) ?? default,
        ...
        public IMaterial GetClone(decimal massFraction = 1)
            ...
            : new Material(
                ...
                Density,
                massFraction != 1 ? Mass * (double)massFraction : Mass,
                Shape,
                Temperature);
