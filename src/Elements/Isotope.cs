...
namespace Tavenem.Chemistry.Elements
{
    ...
    public struct Isotope : ISerializable, IEquatable<Isotope>
    {
        /// <summary>
        ...
        private Isotope(SerializationInfo info, StreamingContext context) : this(
            (Element?)info.GetValue(nameof(Element), typeof(Element)) ?? default,
            (bool?)info.GetValue(nameof(IsRadioactive), typeof(bool)) ?? default,
            (ushort?)info.GetValue(nameof(MassNumber), typeof(ushort)) ?? default,
            (double?)info.GetValue(nameof(RelativeAbundance), typeof(double)) ?? default)
        { }
        ...
        public void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue(nameof(MassNumber), MassNumber);
            info.AddValue(nameof(RelativeAbundance), RelativeAbundance);
        }
