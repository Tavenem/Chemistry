...
namespace Tavenem.Chemistry.Elements
{
    ...
    [Serializable]
    [DataContract]
    public struct Orbital : ISerializable, IEquatable<Orbital>
    {
        /// <summary>
        ...
        private Orbital(SerializationInfo info, StreamingContext context) : this(
            (byte?)info.GetValue(nameof(Shell), typeof(byte)) ?? default,
            (char?)info.GetValue(nameof(Type), typeof(char)) ?? default,
            (byte?)info.GetValue(nameof(Number), typeof(byte)) ?? default)
        { }
        ...
        public void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue(nameof(Shell), Shell);
