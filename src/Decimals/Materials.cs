...
namespace Tavenem.Chemistry.Decimals
{
    ...
    public static class Materials
    {
        ...
        /// zero <see cref="IMaterial.Mass"/>; or <see cref="decimal.MaxValue"/> if it has a
        /// radius of zero.
        /// </returns>
        public static decimal GetSurfaceGravity(this IMaterial material)
        {
            if (material.Mass == 0)
            {
                return 0;
            }
            if (material.Shape.ContainingRadius == 0)
            {
                return decimal.MaxValue;
            }
            return Mathematics.DecimalConstants.G * material.Mass / material.Shape.ContainingRadius.Square();
        }
            ...
            double? pressure = null) where T : IMaterial
        {
            ...
            material.Shape = material.Shape.ScaleVolume((mass ?? material.Mass) / (decimal)(density ?? material.Density) / material.Shape.Volume);
            return material;
        }
        ...
        {
            material.Mass = (decimal)material.Density * material.Shape.Volume;
            return material;
        }
